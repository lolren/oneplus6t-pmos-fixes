...
The package also installs `pmos-manage-camera-generation`, the current r7/r2
and legacy r7/r1 immutable manifests, the public verification key and the
non-image all-sensor runner. The
