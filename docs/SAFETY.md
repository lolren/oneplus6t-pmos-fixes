...
require fresh explicit approval after the current r8/r22/r6/r3 state, retained
...
exact version constraints and must list only the four documented downgrades in
simulation.
