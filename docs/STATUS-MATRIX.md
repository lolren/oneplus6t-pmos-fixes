...
| Native camera UI | Advanced Snapshot r11 source with tap-focus reticle, exposure/colour/contrast/detail controls, 1x–4x pinch/slider zoom, latest-frame preview scheduling, save-failure feedback and guarded rear hardware-flash switch | Clean GTK/Aperture tests and source wiring pass; AArch64 package and LED/capture acceptance pending | Verify visual preview latency, saved images, playable video and rear LED restoration on the phone |
