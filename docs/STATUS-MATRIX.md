...
| Mobile data | NetworkManager profile helper; provider database lookup; GID1-aware MVNO overlay; explicit APN fallback; managed rollback | APN tests pass; live SMARTY/3 UK LTE bearer, QMAP-forced traffic and Wi-Fi-off DNS/HTTPS pass | Repeat after a cold boot and test an additional non-SMARTY SIM to broaden carrier acceptance |
